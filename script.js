      ...
      switch (key) {
        case "backspace":
          ...
          keyElement.addEventListener("click", () => {
            MakeSoundForKeys(261.6, 'triangle');
        ...
        case "enter":
          ...
          keyElement.addEventListener("click", () => {
            MakeSoundForKeys(170.0, 'triangle');
        ...
        case "space":
          ...
          keyElement.addEventListener("click", () => {
            if(this.properties.english) MakeSoundForKeys(100.31, 'triangle');
            else MakeSoundForKeys(60.31, 'triangle');
            this.properties.value = this.properties.value.toString().splice(this.properties.curentCursor, 0, " ");
            this.properties.curentCursor+=1;
            this._triggerEvent("oninput");
            var elem = document.getElementById("myTextArea");
        ...
        case "voice":
            ...
            keyElement.addEventListener("click", () => {
              if(this.properties.english)rec.lang = 'en-US';
              else rec.lang = 'ru';
              isRecognition = !isRecognition;
              if(isRecognition) {
                keyElement.classList.add("keyboard__key--lighting");
                rec.start();
              } else {
                keyElement.classList.remove("keyboard__key--lighting");
                rec.stop();
              } 
            });
...
function MakeSoundForKeys(frequency, type){
    if(isSound){
